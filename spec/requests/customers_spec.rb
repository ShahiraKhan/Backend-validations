...
describe "get new_customer_path" do
  ...
  describe "put customer_path with valid data" do
    it "updates an entry and redirects to the show path for the customer" do
      # Changing the last_name "Shareef" to "Khan"
      customer = FactoryBot.create(:customer, last_name:"Shareef")
      expect(customer.last_name).to eq("Shareef")
      put customer_path(customer.id), params: {customer: {last_name:"Khan"}}
      customer.reload
      expect(customer.last_name).to eq("Khan")
    end  
  end
